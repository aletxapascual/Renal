          ...
          >
            <p className="font-sans text-lg text-gray-600 leading-relaxed text-center">
              {language === 'es'
                ...
                : 'In our company, we firmly believe that renal care must go far beyond the technical or the routine. Each patient is a person with emotions, needs, and a unique story, so we focus on offering comprehensive care that combines reliable technology with a true vocation for service. In addition to offering safe and effective treatments, we accompany our patients with the final goal in mind: kidney transplantation and a better quality of life.'}
            </p>
          </motion.div>
        </div>
      </div>
