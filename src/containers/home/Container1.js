...
function Container1() {
  ...
  return (
    <div id="container1" className="relative min-h-[600px] bg-gradient-to-br from-white via-[#5773BB]/10 to-[#5773BB]/20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          {/* Text Content with enhanced colors and animations */}
          <div className="space-y-6 transform transition-all duration-500 hover:translate-y-[-8px]">
            <h4 className="font-sans text-[#5773BB] text-3xl mb-4 opacity-0 animate-fadeIn bg-gradient-to-r from-[#5773BB] to-[#4466B7] bg-clip-text text-transparent">
              Bienvenido a
            </h4>
            <h1 className="font-sans text-5xl font-bold mb-8 opacity-0 animate-fadeIn animation-delay-200 bg-gradient-to-r from-[#5773BB] via-[#4466B7] to-[#5773BB] bg-clip-text text-transparent">
              Hemodiálisis Renal
            </h1>
            <p className="font-sans text-lg text-gray-700 mb-8 opacity-0 animate-fadeIn animation-delay-400 leading-relaxed">
              Desde 2005, en <span className="font-medium text-[#5773BB] hover:text-[#4466B7] transition-colors">RENALSTAR PENINSULAR</span> ofrecemos hemodiálisis de alta calidad con tecnología avanzada y un enfoque amigable, brindando un beneficio psicológico a nuestros pacientes.
            </p>
            <Link
              to="/contacto"
              onMouseEnter={() => setIsHovered(true)}
              onMouseLeave={() => setIsHovered(false)}
              className="font-sans inline-flex items-center justify-center px-8 py-4 text-lg font-medium text-white bg-gradient-to-r from-[#5773BB] to-[#4466B7] hover:from-[#4466B7] hover:to-[#5773BB] rounded-full transition-all duration-300 transform hover:scale-105 hover:shadow-lg group"
            >
          ...
          <div className="relative transform transition-all duration-500 hover:translate-y-[-8px]">
            <div className="aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl hover:shadow-3xl transition-shadow duration-300 ring-1 ring-[#5773BB]/10">
              {slides.map((slide, index) => (
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[#5773BB]/90 via-[#5773BB]/70 to-transparent p-6 transform transition-transform duration-300">
            ...
            <div className="absolute inset-y-0 left-0 right-0 flex items-center justify-between p-4">
              <button
                onClick={prevSlide}
                className="p-3 rounded-full bg-white/90 hover:bg-white text-[#5773BB] transition-all duration-300 transform hover:scale-110 hover:shadow-lg backdrop-blur-sm"
              >
