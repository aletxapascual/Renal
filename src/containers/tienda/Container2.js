          ...
          {sortedProducts.map((product, index) => (
            ...
            >
              <Link to={`/tienda/${product.id}`} className="block">
                <div className="bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 p-8 h-full flex flex-col border border-gray-100 cursor-pointer">
